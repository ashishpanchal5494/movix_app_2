...
const configurationEndpoint = `${apiBaseUrl}/configuration?api_key=${apiKey}`;

const movieDetailsEndpoint = id=> `${apiBaseUrl}/movie/${id}?api_key=${apiKey}`;
const movieVideosEndpoint = id=> `${apiBaseUrl}/movie/${id}/video?api_key=${apiKey}`;
...
export const fetchConfiguration = ()=>{
    return apiCall(configurationEndpoint);
}
